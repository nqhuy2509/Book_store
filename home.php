...
<body>
    ...
    <section class="home">
        <div class="content">
            ...
            <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Deleniti, doloremque. Facilis ullam molestias numquam commodi eum a veniam ducimus dignissimos eius architecto porro atque omnis, earum culpa, esse excepturi voluptatum!</p>
            <a href="about.php" class="white-btn">Khám phá thêm</a>
        </div>
    </section>

    <section class="products">
        <h1 class="title">Tác phẩm mới nhất</h1>
